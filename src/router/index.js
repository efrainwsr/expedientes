        ...
        children: [
            {
                ...
                meta: { requiresAuth: true, roles: [0, 1, 2] }
            },
            {
                path: '/bandas',
                name: 'bandas',
            ...
            },
            {
                ...
                name: 'organismos',
                meta: { requiresAuth: true, roles: [0, 1] },
                component: () => import('@/views/Organismos.vue')
            },
            {
                path: '/usuarios',
                name: 'usuarios',
...
router.beforeEach((to, from, next) => {
    ...
    if (to.meta.requiresAuth && !isLoggedIn) {
        next({ name: 'login' });
    } else if (to.meta.roles && (!user || !to.meta.roles.some(role => user.roles.includes(role.toString())))) {
